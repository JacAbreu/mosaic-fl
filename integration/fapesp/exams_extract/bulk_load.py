"""bulk_load.py — Fase 2: carrega o CSV em metrics.exam_records, resolvendo canonical e classificação."""
import logging
...
from .column_mapping import _BATCH_SIZE, _RESOLVER
from .lookups import _load_alias_cache, _load_canonical_refs, _resolve_canonical

...
from mosaicfl.v2.server_v2 import (
    ...
    weighted_average_accuracy, weighted_average_loss,
)
...
class TestWeightedAverageV2:
    ...
    def test_weighted_average_is_alias_for_accuracy(self):
...
class TestWeightedAverageLoss:
    """
    weighted_average_loss é usado como fit_metrics_aggregation_fn.
    fit() retorna {"loss": float} — chave diferente de weighted_average_accuracy.
    Antes desta correção, weighted_average tentava acessar m["accuracy"]
    em métricas de fit e retornava {} silenciosamente.
    """
    ...
    def test_fit_metrics_dict_does_not_raise(self):
        """Reproduz o bug original: weighted_average com {"loss": float} retornava {}."""
    ...
    def test_missing_key_defaults_to_zero(self):
        """Cliente que não retornou a chave esperada não quebra a agregação."""

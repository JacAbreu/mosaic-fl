"""
experiments/training/core — mecânica do pipeline federado do MOSAIC-FL.
...
Consumido por experiments/training/federated_training.py (shim de compatibilidade)
e experiments/training/experiment_server.py (adapter de servidor Flower).
"""
import sys

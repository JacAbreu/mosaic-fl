...
Uso:
    python experiments/training_runner/run_seed_sensitivity.py [--rounds 30] [--seeds 42 7 123]
    # ou via Makefile:
...
from experiments.training.core.fl_core import run_federated_learning_manual

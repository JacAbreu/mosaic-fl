...
Como usar
---------
  Desktop  → python experiments/training_runner/run_federated_real.py --mode server
  Notebook → python experiments/training_runner/run_federated_real.py --mode client --server 192.168.X.X:8080

  Para verificar conectividade antes de iniciar:
  Notebook → python experiments/training_runner/run_federated_real.py --check --server 192.168.X.X:8080
...
Exemplos:
  ...
  python experiments/training_runner/run_federated_real.py --mode server

  # Notebook — conecta ao servidor do desktop
  python experiments/training_runner/run_federated_real.py --mode client --server 192.168.1.100:8080

  # Notebook — verifica conectividade antes de iniciar
  python experiments/training_runner/run_federated_real.py --check --server 192.168.1.100:8080
        """,
    )

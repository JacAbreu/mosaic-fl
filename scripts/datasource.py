"""
scripts/datasource.py
Strategy Pattern para fontes de dados do cliente federado.

Implementação canônica: infrastructure/mosaicfl_client/datasource.py
Este arquivo permanece em scripts/ para referência / scripts legados.
...
Uso:
    from scripts.datasource import DataSourceFactory
